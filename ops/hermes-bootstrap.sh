...
#
# 검증 결과(2026-05-29): hermes 0.3.1, `from hermes.batch import batch_runner` OK.
#
# 사용법:
...
echo "[bootstrap] verify: ${DEST}/.venv/bin/python -c 'from hermes.batch import batch_runner; print(\"OK\")'"
